...
app.post('/api/employee-deduction-configs', express.json({ limit: '10mb' }), async (req, res) => {
  try {
    const body = req.body;
...
app.put('/api/employee-deduction-configs/:employee_uuid/:deduction_id', jsonParser, async (req, res) => {
  try {
    const body = req.body;
